      ...
      <div className="h-[91px] flex items-center justify-between px-4 sm:px-8 md:px-16 lg:px-[120px]">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="relative" ref={menuRef}>
            ...
            {/* Dropdown Menu */}
            {isProfileMenuOpen && (
              <div className="absolute top-8 -right-10 mt-2 w-38 bg-white dark:bg-black rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50">
                {isAuthenticated ? (
                  <>
                    ...
                    <Link
                      ...
                      className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-background dark:hover:bg-gray-700 transition-colors"
                    >
